...
- W11737351 — `technical-manual-w11737351-reva access manual fl dryers.pdf` — [WHIRLPOOL_W11737351_FL_DRYER_ACCESS_EXTRACTION.md](../../knowledge/pattern-catalog/WHIRLPOOL_W11737351_FL_DRYER_ACCESS_EXTRACTION.md) (access diagrams only)
...
Whirlpool/Maytag **CCU/ACU-era** dryers (WED/WGD/MED/MGD, including **WED5620/WED56*/WED66***, **WED7*/MED7***, **WED95*/MED95***, and **WED96*/MED96*** steam). **Not** Duet Sport 83/85 — those use `whirlpool_duet_sport_dryer`. **Not** WED51* top-load — `whirlpool_acu_tl_dryer`.
