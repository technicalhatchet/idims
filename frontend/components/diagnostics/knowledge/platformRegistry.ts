...
export const PLATFORM_IDS = {
  ...
  SAMSUNG_DISHWASHER: 'samsung_dishwasher',
  SAMSUNG_DISHWASHER_M9: 'samsung_dishwasher_m9',
  SAMSUNG_LAUNDRY_COMBO: 'samsung_laundry_combo',
  SAMSUNG_FRIDGE_RF28: 'samsung_fridge_rf28',
  SAMSUNG_TL_WASHER_A50: 'samsung_tl_washer_a50',
  SAMSUNG_TL_WASHER_CG71: 'samsung_tl_washer_cg71',
  SAMSUNG_TL_DRYER_DV50: 'samsung_tl_dryer_dv50',
  SAMSUNG_TL_DRYER_CG71: 'samsung_tl_dryer_cg71',
  SAMSUNG_FL_WASHER_WF6000R: 'samsung_fl_washer_wf6000r',
  SAMSUNG_RANGE_NX60: 'samsung_range_nx60',
  SAMSUNG_RANGE_NE58: 'samsung_range_ne58',
  SAMSUNG_RANGE_NY63: 'samsung_range_ny63',
  SAMSUNG_HP_DRYER_DV22N: 'samsung_hp_dryer_dv22n',
  LG_FL_WASHER_WM4000: 'lg_fl_washer_wm4000',
  LG_FREESTANDING_RANGE: 'lg_freestanding_range',
  LG_LRMVS: 'lg_lrmvs',
  LG_SXS: 'lg_sxs',
  ...
  WHIRLPOOL_SXS_W11296289: 'whirlpool_sxs_w11296289',
  WHIRLPOOL_KA_FRENCH_DOOR: 'whirlpool_ka_french_door',
  WHIRLPOOL_BELLA_FRENCH_DOOR: 'whirlpool_bella_french_door',
  WHIRLPOOL_ACU_FD_INVERTER: 'whirlpool_acu_fd_inverter',
  WHIRLPOOL_THESEUS_CDFD: 'whirlpool_theseus_cdfd',
  MIDEA_RSS: 'midea_rss',
  ...
  SAMSUNG_MICROWAVE_OTR: 'samsung_microwave_otr',
  INSIGNIA_DRYER_TDRE: 'insignia_dryer_tdre',
  WHIRLPOOL_CCU_DRYER: 'whirlpool_ccu_dryer',
  WHIRLPOOL_CCU_TL_DRYER: 'whirlpool_ccu_tl_dryer',
  ...
  WHIRLPOOL_TL_PSC_WASHER: 'whirlpool_tl_psc_washer',
...
export const PLATFORM_RULES: PlatformRule[] = [
  ...
  {
    id: PLATFORM_IDS.WHIRLPOOL_TL_DD,
    label: 'Whirlpool Cabrio 5.3 cu ft direct-drive top-load (W10758836)',
    manufacturers: ['Whirlpool', 'Maytag'],
    templateId: 'washer',
    modelPatterns: [/WTW85/i, /MVWB85/i],
  },
  {
    id: PLATFORM_IDS.WHIRLPOOL_TL_PSC_WASHER,
    label: 'Whirlpool/Maytag Multimedia Enhanced PSC top-load (W11428632)',
    manufacturers: ['Whirlpool', 'Maytag'],
    templateId: 'washer',
    modelPatterns: [/WTW5/i, /WTW6/i, /WTW7/i, /WTW8/i, /MVW5/i, /MVW6/i, /MVW7/i],
  },
  {
    id: PLATFORM_IDS.WHIRLPOOL_TL_DD,
  ...
  {
    id: PLATFORM_IDS.SAMSUNG_DISHWASHER_M9,
    label: 'Samsung premium dishwasher DW80M9 (Waterwall / Auto Door)',
    manufacturers: ['Samsung'],
    templateId: 'dishwasher',
    modelPatterns: [/DW80M9/i, /DW80M99/i, /DW80M95/i],
  },
  {
    id: PLATFORM_IDS.SAMSUNG_DISHWASHER,
    label: 'Samsung dishwasher (DW80/DW82/DW60 family)',
    manufacturers: ['Samsung'],
    templateId: 'dishwasher',
    modelPatterns: [/DW80/i, /DW82/i, /DW60/i, /DW50/i],
  },
  {
    ...
    manufacturers: ['Samsung'],
    templateId: 'washer',
    modelPatterns: [/WA50R/i, /WA51D/i, /WA52D/i, /WF45A/i],
  },
  {
    id: PLATFORM_IDS.SAMSUNG_TL_WASHER_CG71,
    label: 'Samsung top-load washer CG71 family (WA55CG71, WA54CG)',
    manufacturers: ['Samsung'],
    templateId: 'washer',
    modelPatterns: [/WA55CG/i, /WA54CG/i, /WA55A7/i],
  },
  {
  ...
  {
    id: PLATFORM_IDS.SAMSUNG_TL_DRYER_CG71,
    label: 'Samsung top-load dryer CG71 family (electric)',
    manufacturers: ['Samsung'],
    templateId: 'electric_dryer',
    modelPatterns: [/DVE55CG/i, /DV55CG/i],
  },
  {
    id: PLATFORM_IDS.SAMSUNG_TL_DRYER_CG71,
    label: 'Samsung top-load dryer CG71 family (gas)',
    manufacturers: ['Samsung'],
    templateId: 'gas_dryer',
    modelPatterns: [/DVG55CG/i],
  },
  {
  ...
  {
    id: PLATFORM_IDS.SAMSUNG_FL_WASHER_WF6000R,
    label: 'Samsung front-load washer WF6000R (WF45T/WF45R/WF22R)',
    manufacturers: ['Samsung'],
    templateId: 'washer',
    modelPatterns: [/WF45T/i, /WF45R61/i, /WF45R63/i, /WF22R62/i, /WF20T60/i],
  },
  {
  ...
  },
  {
    ...
    label: 'Samsung FlexWash dual-load (WV55/WV60)',
    manufacturers: ['Samsung'],
    templateId: 'washer',
    modelPatterns: [/WV55/i, /WV60/i],
  },
  {
    id: PLATFORM_IDS.SAMSUNG_LAUNDRY_COMBO,
    label: 'Samsung all-in-one laundry combo (WD53/WD80)',
    manufacturers: ['Samsung'],
    templateId: 'aio_laundry',
    modelPatterns: [/WD53/i, /WD80/i],
  },
  {
    ...
    manufacturers: ['Samsung'],
    templateId: 'refrigerator',
    modelPatterns: [/RF260/i, /RF261/i, /RS28/i, /RS23A5/i, /RS22T/i, /RS27/i, /RS28T5B/i, /RS5300/i],
  },
  {
  ...
  {
    id: PLATFORM_IDS.SAMSUNG_FRIDGE_RF28,
    label: 'Samsung RF28 French-door refrigerator (RF28R)',
    manufacturers: ['Samsung'],
    templateId: 'refrigerator',
    modelPatterns: [/RF28R/i, /RF28/i],
  },
  {
  ...
  {
    id: PLATFORM_IDS.SAMSUNG_RANGE_NE58,
    label: 'Samsung NE58 Flex Duo electric range',
    manufacturers: ['Samsung'],
    templateId: 'electric_range',
    modelPatterns: [/NE58F/i, /FER710/i],
  },
  {
    id: PLATFORM_IDS.SAMSUNG_RANGE_NE58,
    label: 'Samsung NE58 induction range',
    manufacturers: ['Samsung'],
    templateId: 'induction_range',
    modelPatterns: [/NE58R/i],
  },
  {
    id: PLATFORM_IDS.SAMSUNG_RANGE_NY63,
    label: 'Samsung NY63/NY64 dual-fuel range',
    manufacturers: ['Samsung'],
    templateId: 'dual_fuel_range',
    modelPatterns: [/NY63/i, /NY64/i],
  },
  {
    id: PLATFORM_IDS.SAMSUNG_HP_DRYER_DV22N,
    label: 'Samsung DV22N heat-pump dryer',
    manufacturers: ['Samsung'],
    templateId: 'electric_dryer',
    modelPatterns: [/DV22N/i],
  },
  {
    id: PLATFORM_IDS.LG_FREESTANDING_RANGE,
    label: 'LG freestanding electric range (LRE)',
    manufacturers: ['LG'],
    templateId: 'electric_range',
    modelPatterns: [/LRE/i],
  },
  {
    id: PLATFORM_IDS.LG_FREESTANDING_RANGE,
    label: 'LG freestanding & slide-in gas range (LRGL/LSG)',
    manufacturers: ['LG'],
    templateId: 'gas_range',
    modelPatterns: [/LRGL/i, /LSG/i],
  },
  {
    id: PLATFORM_IDS.LG_FL_WASHER_WM4000,
    label: 'LG WM4000H*A TurboWash Direct Drive FL washer',
    manufacturers: ['LG'],
    templateId: 'washer',
    modelPatterns: [/WM4000/i, /WM3900/i, /WM3700/i, /WM3600/i, /WM3500/i, /WM3460/i, /WM3400/i],
  },
  {
  ...
  {
    id: PLATFORM_IDS.LG_SXS,
    label: 'LG LSC27926 side-by-side refrigerator',
    manufacturers: ['LG'],
    templateId: 'refrigerator',
    modelPatterns: [/LSC27926/i],
  },
  {
  ...
  {
    id: PLATFORM_IDS.WHIRLPOOL_BELLA_FRENCH_DOOR,
    label: 'Whirlpool Orion+GF2 French door (W10901168 / W11366204)',
    manufacturers: ['Whirlpool', 'KitchenAid', 'Maytag', 'JennAir'],
    templateId: 'refrigerator',
    modelPatterns: [
      /WRF954/i, /WRF964/i, /WRF974/i, /WRF984/i, /WRF972/i,
      /WRFA94/i, /WRF992/i, /WRF993/i, /WRF995/i,
      /KRFC60/i, /KRFC70/i, /KRFC80/i,
      /JFFCC72/i,
    ],
  },
  {
  ...
  {
    id: PLATFORM_IDS.WHIRLPOOL_ACU_FD_INVERTER,
    label: 'Whirlpool ACU inverter French door 31 cu ft (W11819775)',
    manufacturers: ['Whirlpool', 'KitchenAid', 'Maytag'],
    templateId: 'refrigerator',
    modelPatterns: [/WRF31/i, /WRX73/i, /KRMF91/i],
  },
  {
    id: PLATFORM_IDS.WHIRLPOOL_THESEUS_CDFD,
    label: 'Whirlpool Theseus counter-depth French door 24 cu ft (W11803249)',
    manufacturers: ['Whirlpool', 'KitchenAid', 'Maytag'],
    templateId: 'refrigerator',
    modelPatterns: [/WRF24/i, /WRQ24/i, /WRF56/i],
  },
  {
  ...
  {
    id: PLATFORM_IDS.SAMSUNG_MICROWAVE_OTR,
    label: 'Samsung over-the-range microwave (ME11/ME21)',
    manufacturers: ['Samsung'],
    templateId: 'microwave',
    modelPatterns: [/ME11/i, /ME21/i, /ME21K/i, /ME21A/i],
  },
  {
  ...
  {
    id: PLATFORM_IDS.WHIRLPOOL_CCU_TL_DRYER,
    label: 'Whirlpool/Maytag CCU top-load dryer (W10410465)',
    manufacturers: ['Whirlpool', 'Maytag'],
    templateId: 'electric_dryer',
    modelPatterns: [
      /WED66/i, /WGD66/i, /MED66/i, /MGD66/i,
      /WED75/i, /WGD75/i, /MED75/i, /MGD75/i,
      /WED78/i, /WGD78/i, /MED78/i, /MGD78/i,
      /WED80/i, /WGD80/i, /MED80/i, /MGD80/i,
      /WED8500/i, /WGD8500/i, /MED8500/i, /MGD8500/i,
      /WED8600/i, /WGD8600/i, /MED8600/i, /MGD8600/i,
    ],
  },
  {
    id: PLATFORM_IDS.WHIRLPOOL_CCU_TL_DRYER,
    label: 'Whirlpool/Maytag CCU top-load dryer (W10410465, gas)',
    manufacturers: ['Whirlpool', 'Maytag'],
    templateId: 'gas_dryer',
    modelPatterns: [
      /WED66/i, /WGD66/i, /MED66/i, /MGD66/i,
  ...
  },
  {
    ...
    label: 'Whirlpool/Maytag 27 in FL console/LCD dryer (WED5620/WED56*/WED66*)',
    manufacturers: ['Whirlpool', 'Maytag'],
    templateId: 'electric_dryer',
    modelPatterns: [/WED56/i, /WED66/i, /WED562/i, /MED56/i, /MED66/i],
  },
  {
    id: PLATFORM_IDS.WHIRLPOOL_CCU_DRYER,
    label: 'Whirlpool/Maytag 27 in FL console/LCD dryer (WGD56*/WGD66*, gas)',
    manufacturers: ['Whirlpool', 'Maytag'],
    templateId: 'gas_dryer',
    modelPatterns: [/WGD56/i, /WGD66/i],
  },
  {
    id: PLATFORM_IDS.WHIRLPOOL_CCU_DRYER,
