...
- **Maytag / Kenmore** — usually Whirlpool or Electrolux rebadge; source parent OEM manual when possible. Maytag model prefixes resolve to Whirlpool platforms via `whirlpoolOemRebadge.ts` (MED→WED, MHWE→WFW, MFI→WRF, …).
