...
const PATTERNS_BY_TEMPLATE: Record<string, DiagnosisPattern[]> = {
  ...
  washer: [
    ...
    {
      id: 'diag_bearing',
      pattern: /\bbearing\b|\btub\s*seal\b/,
      target: 'drum_bearing',
      targetLayer: 'component',
      value: 10,
      explanation: 'Diagnosis mentions bearing — mechanical path noted.',
    },
    {
      id: 'diag_suspension',
      pattern: /\bsuspension\b|\bshock\b|\bdamper\b/,
      target: 'suspension',
      targetLayer: 'component',
      value: 10,
      explanation: 'Diagnosis mentions suspension — mechanical path noted.',
    },
    {
      id: 'diag_belt',
      pattern: /\bbelt\b|\bpulley\b/,
      target: 'drive_belt',
      targetLayer: 'component',
      value: 8,
      explanation: 'Diagnosis mentions belt or pulley — mechanical drive path noted.',
    },
    {
      id: 'diag_motor_controller',
      pattern: /\binverter\b|\bmotor\s*control\b|\bmcu\b|\bf28\b/,
      target: 'motor_controller',
      targetLayer: 'component',
      value: 10,
      explanation: 'Diagnosis mentions motor controller or inverter — comm path noted.',
    },
    {
      id: 'diag_drive_motor',
