          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="rounded-lg p-6 border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow">
              <div className="w-12 h-12 bg-purple-100 dark:bg-purple-900 rounded-full flex items-center justify-center mb-4">
                <FaMobileAlt className="text-purple-600 dark:text-purple-400 text-xl" />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                Mobile Access
              </h3>
              <p className="text-gray-600 dark:text-gray-300">
                Access your business data anywhere, anytime. Mobile-friendly design for technicians in the field.
              </p>
            </div>
            ...
            <div className="rounded-lg p-6 border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Give your clients access to their service history, invoices, and the ability to request service online.
              </p>
            </div>
            ...
            <div className="rounded-lg p-6 border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Gain valuable insights with detailed reports and analytics. Track revenue, technician performance, and customer satisfaction.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
              <div className="flex items-center mb-4">
                <div className="h-12 w-12 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center">
                  <span className="text-blue-600 dark:text-blue-400 font-bold text-xl">AC</span>
                </div>
                <div className="ml-4">
                  <h4 className="font-semibold text-gray-900 dark:text-white">Alex Chen</h4>
                  <p className="text-gray-600 dark:text-gray-400">HVAC Solutions</p>
                </div>
              </div>
              <p className="text-gray-700 dark:text-gray-300 italic">
                "This platform has completely transformed how we manage our service calls. The scheduling feature alone has saved us countless hours and reduced missed appointments by 80%."
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
              <div className="flex items-center mb-4">
                <div className="h-12 w-12 rounded-full bg-green-100 dark:bg-green-900 flex items-center justify-center">
                  <span className="text-green-600 dark:text-green-400 font-bold text-xl">SM</span>
                </div>
                <div className="ml-4">
                  <h4 className="font-semibold text-gray-900 dark:text-white">Sarah Miller</h4>
                  <p className="text-gray-600 dark:text-gray-400">Elite Plumbing</p>
                </div>
              </div>
              <p className="text-gray-700 dark:text-gray-300 italic">
                "The invoicing system integrates perfectly with our accounting software. We've reduced our billing time by 60% and improved our cash flow significantly."
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
              <div className="flex items-center mb-4">
                <div className="h-12 w-12 rounded-full bg-purple-100 dark:bg-purple-900 flex items-center justify-center">
                  <span className="text-purple-600 dark:text-purple-400 font-bold text-xl">JD</span>
                </div>
                <div className="ml-4">
                  <h4 className="font-semibold text-gray-900 dark:text-white">James Davis</h4>
                  <p className="text-gray-600 dark:text-gray-400">Davis Electrical</p>
                </div>
              </div>
              <p className="text-gray-700 dark:text-gray-300 italic">
                "Our technicians love having all client information and service history at their fingertips. Client satisfaction has improved dramatically since we can provide more personalized service."
              </p>
            </div>
          </div>
        </div>
