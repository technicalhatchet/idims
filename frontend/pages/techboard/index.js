...
/**
 * Next job card: unfinished visits today — active visit first, then earliest
 * incomplete appointment in schedule order (even if its start time has passed).
 */
  ...
  return (
    <>
      <Head>
        ...
        <link rel="manifest" href="/manifest-techboard.json?v=6" />
        {/* iOS Add to Home Screen uses apple-touch-icon, not manifest icons */}
        <link rel="apple-touch-icon" sizes="180x180" href="/idimsicon-180x180.png?v=6" />
        <link rel="apple-touch-icon" href="/idimsicon-180x180.png?v=6" />
