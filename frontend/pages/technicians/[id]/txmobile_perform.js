      ...
      titleplate={
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="tx-perform-hud-orbitron text-[8px] uppercase tracking-[0.2em] text-cyan-300/95 mb-1">Performance</p>
      ...
      <div className="flex gap-2 mb-4 overflow-x-auto pb-1" data-hud-card>
        {['week', 'month', 'quarter', 'year'].map((periodOption) => (
          <button
            ...
            style={{
              background: period === periodOption ? 'rgba(34, 211, 238, 0.25)' : 'rgba(13, 21, 37, 0.4)',
        ...
        <>
          <div className="grid grid-cols-2 gap-3 mb-4">
            {[
              ...
              <div key={label} className="rounded-lg p-4 border border-cyan-400/30 bg-[rgba(13,21,37,0.85)]" data-hud-card>
          ...
          {performance.details && (
            <div className="rounded-lg p-4 border border-cyan-400/30 bg-[rgba(13,21,37,0.85)]" data-hud-card>
