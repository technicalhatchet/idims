...
function PaymentDetail() {
  ...
  return (
    <>
      <Head>
        <title>{`Payment ${payment.payment_number} | Service Business Management`}</title>
      </Head>
      ...
      <div className="px-4 py-6">
        ...
        <div className="flex flex-col md:flex-row justify-between md:items-center mb-6">
          <div>
            ...
            <p className="text-gray-500 mt-1">Amount: ${payment.amount.toFixed(2)}</p>
          </div>
...
PaymentDetail.getLayout = function getLayout(page) {
  return <DashboardLayout>{page}</DashboardLayout>;
};

export default withPageAuthRequired(PaymentDetail);