          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/30 mb-6"
                   style={{ boxShadow: '0 0 20px 4px rgba(249,115,22,0.35)' }}>
                <HiLightningBolt className="w-4 h-4 text-cyan-400" />
                <span className="text-cyan-400 text-sm font-medium" style={{ textShadow: '0 0 6px rgba(249,115,22,1), 0 0 12px rgba(249,115,22,0.8)' }}>Same-Day Service Available</span>
              </div>
