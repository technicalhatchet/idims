    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          yn('door_switch', 'Door reed switch toggles (open ≈5 V / closed ≈0 V)'),
          yn('fans_on_compressor_off', 'Fans run but compressor stays off'),
          gb('display_panel', 'Display panel responds to keys'),
          yn('defrost_cycle_observed', 'Defrost Cycle Heard / Observed'),
          yn('adc_defrost_test_entered', 'ADC defrost test mode entered (relay click)'),
      ...
      },
      {
        ...
        fields: [
          ...
          txt('adc_heater_output_v', 'ADC defrost heater output P2–P6 (V)'),
      ...
      },
      {
        ...
        fields: [
          ...
          txt('adc_cooling_output_v', 'ADC cooling output P6–P4 (V)'),
      ...
      {
        id: 'ice_maker_diagnostics',
        title: 'Modular Ice Maker (2225623)',
        fields: [
          yn('im_power_ln', 'L–N module power OK (120 V)'),
          txt('im_mold_heater_ohms', 'Mold heater L–H (Ω)'),
          txt('im_motor_ohms', 'Motor L–M (Ω, motor off support)'),
          txt('im_bimetal_ohms', 'Bimetal cold continuity (Ω)'),
          txt('im_bimetal_th_voltage', 'Bimetal T–H live (V or open/closed)'),
          txt('im_water_valve_nv', 'Water valve N–V during fill (V)'),
          txt('im_harness_fuse_ohms', 'Harness thermal fuse (Ω)'),
          txt('im_water_fill_adjustment', 'Water fill adjustment (turns / notes)'),
          area('im_test_point_notes', 'Module test point notes (L, N, M, T, H, V)'),
        ],
      },
