#!/usr/bin/env python3
"""CG-9.5 WP4 — Apply human gate approval for Midea RSS SxS compounding."""
...
TABLE_PATH = CALIBRATION / "MIDEA_RSS_SXS_overlay_mapping_table_v1.json"
LEDGER_PATH = CALIBRATION / "MIDEA_RSS_SXS_gate_decision_ledger_v1.json"
OBSERVATION_PATH = CALIBRATION / "MIDEA_RSS_SXS_cg95_compounding_observation_v1.json"
REVIEWER = "human_gate_cg95_wp4"
...
def main() -> int:
    ...
    observation = {
        ...
        "verdict": {
            "canonicalInheritances": 3,
            "conditionalBindings": 5,
            "overlayLearningEvents": 10,
            "intentionalAbstentions": 5,
            "canonicalExpansion": 0,
            "discoveryCorpusInheritance": 0,
            "freezeReopening": 0,
            "ontologyMutations": 0,
        ...
        "verdictNote": (
            "Fourth SxS production compounding — VFD-mediated compressor conditional, B3839 NTC "
            "platform, E4/E5 defrost-sensor platform vocabulary, mandatory-mode control_board. "
            "Door_switch abstained (no standalone seed). Prior Samsung/Whirlpool/LG SxS overlays "
            "not imported. Seven refrigerator overlays now on frozen contract."
        ),
        "gateArtifact": TABLE_PATH.name,
    ...
    print("==> CG-9.5 WP4 Midea RSS SxS human gate applied")
