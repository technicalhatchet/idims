...
ATTACH_MAP: dict[str, str] = {
    "w10410465-motor-circuit.json": "access_ccu_motor",
    "w10410465-moisture-sensor.json": "diag_moisture",
    "w10410465-thermistors.json": "disconnect_p14",
    "w10410465-button-indicator.json": "ui_component_test",
    "w10410465-door-switch.json": "door_diag",
    "w10410465-dryness-adjust.json": "auto_cycle",
    "w10410465-myst-valve.json": "myst_quick_check",
}
...
def patch_seed(path: Path) -> str:
    ...
    data["serviceModes"] = [
        {
            "bundleId": "w10410465-diagnostic-entry",
