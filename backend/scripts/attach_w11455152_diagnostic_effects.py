#!/usr/bin/env python3
"""Attach diagnosticEffects to W11455152 procedure branches that lack them."""
...
SEED_DIR = ROOT / "frontend/components/diagnostics/procedures/seed/whirlpool_tl_dd_6157"
...
PROCEDURE_COMPONENT: dict[str, str] = {
    "w11455152-test-01-acu-power": "supply",
    "w11455152-test-02-valves": "inlet_valve",
    "w11455152-test-03-drive-system": "drive_motor",
    "w11455152-test-03a-shifter": "drive_motor",
    "w11455152-test-03b-motor": "drive_motor",
    "w11455152-test-04-hmi": "hmi_control",
    "w11455152-test-05-water-level": "water_level_sensor",
    "w11455152-test-06-drain-pump": "drain_pump",
    "w11455152-test-07-lid-lock": "door_lock",
}
...
KNOWLEDGE_EVIDENCE: dict[str, tuple[str, str, str]] = {
    ...
    "whirlpoolMvw6200WasherAcu12Vdc": COMPONENT_DEFAULT_EVIDENCE["hmi_control"],
    "whirlpoolMvw6200WasherMotorWindingOhms": COMPONENT_DEFAULT_EVIDENCE["drive_motor"],
    "whirlpoolMvw6200WasherShifterOhms": COMPONENT_DEFAULT_EVIDENCE["drive_motor"],
    "whirlpoolMvw6200WasherInletValveOhms": COMPONENT_DEFAULT_EVIDENCE["inlet_valve"],
    "whirlpoolMvw6200WasherDrainPumpOhms": COMPONENT_DEFAULT_EVIDENCE["drain_pump"],
    "whirlpoolMvw6200WasherLidLockSolenoidOhms": COMPONENT_DEFAULT_EVIDENCE["door_lock"],
    "whirlpoolMvw6200WasherInletThermistorOhms": COMPONENT_DEFAULT_EVIDENCE["wash_ntc"],
}
...
def main() -> None:
    total = 0
    for path in sorted(SEED_DIR.glob("w11455152-test-*.json")):
