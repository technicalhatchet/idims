#!/usr/bin/env python3
"""Attach Samsung WD53 laundry combo Smart Install bundles to component procedures."""
...
ATTACH_MAP = {
    "samsungwd53-motor-circuit.json": ("reconnect_motor", "live_motor_check"),
    "samsungwd53-inlet-valves.json": ("smart_install_valves", "valve_visual"),
    "samsungwd53-drain-pump.json": ("pump_run_check", "drain_verified"),
    "samsungwd53-door-lock.json": ("door_type_check", "door_verified"),
    "samsungwd53-wash-heater.json": ("heater_access", "heater_in_circuit"),
}
