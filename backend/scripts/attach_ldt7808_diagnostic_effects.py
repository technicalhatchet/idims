#!/usr/bin/env python3
"""Attach diagnosticEffects to LG LDT7808 dishwasher procedure branches."""
...
PROCEDURE_COMPONENT: dict[str, str] = {
    "ldt7808-inlet-valve": "inlet_valve",
    "ldt7808-hall-sensor": "inlet_valve",
    "ldt7808-drain-pump": "drain_pump",
    "ldt7808-thermistor": "heater",
    "ldt7808-heater": "heater",
    "ldt7808-wash-motor": "circulation_pump",
    "ldt7808-vario-valve": "circulation_pump",
    "ldt7808-leak-float": "door_gasket",
    "ldt7808-bubble-error": "door_gasket",
    "ldt7808-excess-fill": "inlet_valve",
}
