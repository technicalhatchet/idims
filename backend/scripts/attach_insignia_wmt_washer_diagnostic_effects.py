#!/usr/bin/env python3
"""Attach diagnosticEffects to Insignia WMT41 washer procedure branches."""
...
PROCEDURE_COMPONENT: dict[str, str] = {
    "insigniawmt41-inlet-valves": "inlet_valve",
    "insigniawmt41-drain-motor": "drain_pump",
    "insigniawmt41-lid-switch": "lid_switch",
    "insigniawmt41-unbalance": "suspension",
    "insigniawmt41-impact-switch": "lid_switch",
    "insigniawmt41-level-sensor": "water_level_sensor",
    "insigniawmt41-drive-motor": "drive_motor",
}
...
COMPONENT_DEFAULT_EVIDENCE: dict[str, tuple[str, str, str]] = {
    ...
    "drive_motor": ("drive_motor", "confirm_drive_motor_ol_drive_motor_failed", "eliminate_drive_motor_ol_drive_motor_ok"),
}

KNOWLEDGE_EVIDENCE: dict[str, tuple[str, str, str]] = {
    "insigniaWasherFreqInletValveOhms": COMPONENT_DEFAULT_EVIDENCE["inlet_valve"],
    "insigniaWasherFreqDrainPumpOhms": COMPONENT_DEFAULT_EVIDENCE["drain_pump"],
    "insigniaWasherFreqDriveMotorOhms": COMPONENT_DEFAULT_EVIDENCE["drive_motor"],
    "insigniaWasherLevelSensorFrequency": COMPONENT_DEFAULT_EVIDENCE["water_level_sensor"],
}
