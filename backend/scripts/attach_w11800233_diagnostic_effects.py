#!/usr/bin/env python3
"""Attach diagnosticEffects to W11800233 procedure branches that lack them."""
...
PROCEDURE_COMPONENT: dict[str, str] = {
    "w11800233-test-01-acu-power": "supply",
    "w11800233-test-02-valves": "inlet_valve",
    "w11800233-test-03-drive-system": "drive_motor",
    "w11800233-test-03a-shifter": "drive_motor",
    "w11800233-test-03b-motor": "drive_motor",
    "w11800233-test-04-hmi": "hmi_control",
    "w11800233-test-05-water-level": "water_level_sensor",
    "w11800233-test-06-drain-pump": "drain_pump",
    "w11800233-test-07-lid-lock": "door_lock",
}
...
KNOWLEDGE_EVIDENCE: dict[str, tuple[str, str, str]] = {
    ...
    "whirlpoolWtw4100WasherAcu12Vdc": COMPONENT_DEFAULT_EVIDENCE["hmi_control"],
    "whirlpoolWtw4100WasherMotorWindingOhms": COMPONENT_DEFAULT_EVIDENCE["drive_motor"],
    "whirlpoolWtw4100WasherShifterOhms": COMPONENT_DEFAULT_EVIDENCE["drive_motor"],
    "whirlpoolWtw4100WasherInletValveOhms": COMPONENT_DEFAULT_EVIDENCE["inlet_valve"],
    "whirlpoolWtw4100WasherDrainPumpOhms": COMPONENT_DEFAULT_EVIDENCE["drain_pump"],
    "whirlpoolWtw4100WasherLidLockSolenoidOhms": COMPONENT_DEFAULT_EVIDENCE["door_lock"],
}
