#!/usr/bin/env python3
"""Attach W11798430 ACU service diagnostic entry to selected procedure seeds."""
...
ATTACH_MAP: dict[str, str] = {
    "w11798430-motor-circuit.json": "access_acu_motor",
    "w11798430-thermistors.json": "disconnect_j4",
    "w11798430-hmi.json": "ui_component_test",
    "w11798430-door-switch.json": "door_diag",
}
...
def patch_seed(path: Path) -> str:
    ...
    data["serviceModes"] = [
        {
            "bundleId": "w11798430-diagnostic-entry",
