#!/usr/bin/env python3
"""CG-8 WP2 — Publish Samsung RF23BB manufacturer overlay."""
...
def main() -> int:
    print("==> CG-8 Samsung RF23BB WP2 publish")
    ...
    promotion_id = f"promo-SAMSUNG-RF23BB-FD-CG8-{datetime.now(timezone.utc).strftime('%Y%m%d%H%M%S')}"
    ...
    pub_path = CALIBRATION_DIR / "publication_SAMSUNG_RF23BB_FD_CG8.json"
