#!/usr/bin/env python3
"""CG-8 WP3 — Apply human gate approval for LG LRMVS compounding."""
...
TABLE_PATH = CALIBRATION / "LG_LRMVS_FD_overlay_mapping_table_v1.json"
LEDGER_PATH = CALIBRATION / "LG_LRMVS_FD_gate_decision_ledger_v1.json"
OBSERVATION_PATH = CALIBRATION / "LG_LRMVS_fd_cg8_compounding_observation_v1.json"
REVIEWER = "human_gate_cg8_wp3"
        ...
        entries.append(
            {
                ...
                "discoveryCorpusInheritance": False,
...
def main() -> int:
    ...
    table["accounting"]["discoveryCorpusInheritance"] = 0
    ...
    ledger = {
        ...
        "priorPublishedManualIds": ["W10322959", "SAMSUNG-RF23BB-FRIDGE"],
        "entries": entries,
        "summary": summary,
    ...
    observation = {
        ...
        "verdictNote": (
            "Third post-freeze refrigerator compounding pass. LG linear compressor, "
            "multi-compartment NTCs, and standalone condenser-fan diagnostic absorbed by "
            "conditional/platform layers. door_switch withheld despite CG-7 discovery "
            "phrases — procedure evidence discipline holds. Discovery corpus not imported."
        ),
        "gateArtifact": TABLE_PATH.name,
    ...
    print("==> CG-8 WP3 LG LRMVS human gate applied")
    ...
    print(f"discovery inherit:   {summary['discoveryCorpusInheritance']}")
    return 0
