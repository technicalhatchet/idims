...
ATTACH_AFTER_SAFETY = {
    "samsungtlcg71d-thermistor.json",
    "samsungtlcg71d-heater-electric.json",
    "samsungtlcg71d-motor-circuit.json",
    "samsungtlcg71d-hmi.json",
}
...
def patch_seed(path: Path) -> str:
    ...
    data["serviceModes"] = [
        {
            "bundleId": "samsungtlcg71d-smart-install-entry",
