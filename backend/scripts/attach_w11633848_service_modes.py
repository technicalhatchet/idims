#!/usr/bin/env python3
"""Attach W11633848 Service Diagnostics entry bundle to live-test procedures."""
...
BRIDGE_STEP = {
    ...
    "body": "Service Diagnostics cycle should be available (entered via key sequence; cycle starts when door closes). Continue with bench checks below.",
    "sourceExcerpt": "Refer to Component Testing; use Service Diagnostics Cycle for live load verification.",
    "requiresInput": False,
}

# attach after safety, continue to first live Service Diagnostics visual step
LIVE_TEST_PROCEDURES: dict[str, str] = {
    "w11633848-door-switch.json": "live_door_diag",
    "w11633848-fill-valve.json": "live_fill_voltage",
    "w11633848-dispenser.json": "live_dispenser",
    "w11633848-heater.json": "live_heater_voltage",
    "w11633848-owi-sensor.json": "live_owi_5v",
    "w11633848-overfill-switch.json": "live_overfill_fill",
    "w11633848-diverter-motor.json": "live_diverter",
    "w11633848-diverter-sensor.json": "live_position_sensor",
    "w11633848-wash-motor.json": "live_wash_motor",
    "w11633848-drain-motor.json": "live_drain_motor",
    "w11633848-dc-fan.json": "live_fan",
}
...
def service_mode_ref(continue_to: str) -> list[dict[str, str]]:
    return [
        {
            "bundleId": "w11633848-service-diagnostic-entry",
