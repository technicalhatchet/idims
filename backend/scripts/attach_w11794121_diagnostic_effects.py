#!/usr/bin/env python3
"""Attach diagnosticEffects to W11794121 JennAir D.O.S. procedure branches."""
...
PROCEDURE_COMPONENT: dict[str, str] = {
    "w11794121-door-opening-system": "door_gasket",
}
...
def main() -> None:
    total = 0
    for path in sorted(SEED_DIR.glob("w11794121-*.json")):
