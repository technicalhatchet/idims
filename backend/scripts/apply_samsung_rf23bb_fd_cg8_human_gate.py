#!/usr/bin/env python3
"""CG-8 WP2 — Apply human gate approval for Samsung RF23BB compounding."""
...
TABLE_PATH = CALIBRATION / "SAMSUNG_RF23BB_FD_overlay_mapping_table_v1.json"
LEDGER_PATH = CALIBRATION / "SAMSUNG_RF23BB_FD_gate_decision_ledger_v1.json"
OBSERVATION_PATH = CALIBRATION / "SAMSUNG_RF23BB_fd_cg8_compounding_observation_v1.json"
REVIEWER = "human_gate_cg8_wp2"
...
def main() -> int:
    ...
    ledger = {
        ...
        "priorPublishedManualIds": ["W10322959"],
        "entries": entries,
        "summary": summary,
    ...
    observation = {
        ...
        "verdictNote": (
            "Second post-freeze refrigerator compounding pass with stricter manufacturer boundary. "
            "Inverter PBA, multi-NTC scopes, and multi-fan topology absorbed by conditional/platform "
            "layers. door_switch withheld — no independent RF23BB procedure evidence. "
            "Whirlpool Jazz overlay not imported."
        ),
        "gateArtifact": TABLE_PATH.name,
    ...
    print("==> CG-8 WP2 Samsung RF23BB human gate applied")
