#!/usr/bin/env python3
"""Attach W11480208 Service Diagnostics entry bundle to W11794121 D.O.S. live-test procedure."""
...
BRIDGE_STEP = {
    ...
    "body": (
        ...
        "Continue with D.O.S. bench checks below."
    ),
...
LIVE_TEST_PROCEDURES: dict[str, str] = {
    "w11794121-door-opening-system.json": "live_dos_voltage",
}
