#!/usr/bin/env python3
"""Crop OEM diagram pages from W11455152 WTW6157 PSC washer manual."""
...
PDF = ROOT / "backend/docs/manuals/technical-manual-w11455152-reva wtw6157.pdf"
OUT_DIR = ROOT / "frontend/public/images/procedures/whirlpool_tl_dd_6157"
SCALE = 2.0

FIGURES: list[tuple[str, int, str]] = [
    (
        "w11455152-acu-pinout.png",
        32,
        "Main control (Figure 7) & PSC bottom view (Figure 8)",
    ),
]
