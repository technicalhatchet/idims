#!/usr/bin/env python3
"""Attach diagnosticEffects to W11416395 procedure branches that lack them."""
...
PROCEDURE_COMPONENT: dict[str, str] = {
    "w11416395-test-01-acu-power": "supply",
    "w11416395-test-02-valves": "inlet_valve",
    "w11416395-test-03-drive-system": "drive_motor",
    "w11416395-test-03a-shifter": "drive_motor",
    "w11416395-test-03b-motor": "drive_motor",
    "w11416395-test-04-hmi": "hmi_control",
    "w11416395-test-05-temp-thermistor": "wash_ntc",
    "w11416395-test-06-water-level": "water_level_sensor",
    "w11416395-test-07-drain-pump": "drain_pump",
    "w11416395-test-08-lid-lock": "door_lock",
}
