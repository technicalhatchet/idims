#!/usr/bin/env python3
"""Generate W10680150 (Whirlpool CCU electric/gas dryer tech sheet) procedure seeds."""
...
SOURCE = {
    "manualId": "W10680150",
    "manualTitle": "Whirlpool & Maytag CCU Electric/Gas Dryer Service Data Sheet",
    "extractedTextFile": "backend/docs/manuals/whirlpool-electric-gas-dryers-extracted.txt",
...
HEATER_GAS = proc(
    ...
    [
        ...
        instr(
            ...
            "Run w10680150-gas-valve coil checks and verify ignitor 50–500 Ω. Check flame sensor continuity.",
            "gas_heat_verified",
        ),
...
def diagnostic_entry_bundle() -> dict:
    return {
        "id": "w10680150-diagnostic-entry",
        "version": "1.0.0",
        "platformId": "whirlpool_ccu_dryer",
        "manualId": "W10680150",
        "title": "W10680150 — Service Diagnostics entry",
...
BUNDLE_FILES = ["w10680150-diagnostic-entry.json"]
...
def write_catalog() -> None:
    catalog = {
        ...
        "label": "Whirlpool/Maytag CCU electric & gas dryer (tech sheet W10680150)",
        "notes": "Shared platformId for electric_dryer and gas_dryer. Duet Sport 83/85 prefixes use whirlpool_duet_sport_dryer instead.",
        "plannedProcedures": [
            {
                "id": item["id"],
...
def main() -> None:
    ...
    for script_name in (
        "attach_w10680150_diagnostic_effects.py",
        "attach_w10680150_service_modes.py",
    ):
