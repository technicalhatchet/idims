#!/usr/bin/env python3
"""Attach NS-TDRE75W1 service test mode entry to selected procedure seeds."""
...
ATTACH_MAP: dict[str, str] = {
    "nstdre75w1-outlet-thermistor.json": "service_test_ntc",
    "nstdre75w1-humidity-sensor.json": "e4_symptom_check",
    "nstdre75w1-hmi-test.json": "advance_screen_02",
    "nstdre75w1-heater-electric.json": "access_heater_electric",
    "nstdre75w1-motor-circuit.json": "motor_centrifugal",
}
...
def patch_seed(path: Path) -> str:
    ...
    data["serviceModes"] = [
        {
            "bundleId": "nstdre75w1-service-test-entry",
