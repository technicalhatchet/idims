...
ATTACH_MAP = {
    "samsungtlcg71-motor-circuit.json": ("reconnect_motor", "live_motor_check"),
    "samsungtlcg71-inlet-valves.json": ("smart_install_valves", "valve_visual"),
    "samsungtlcg71-drain-pump.json": ("pump_run_check", "drain_verified"),
    "samsungtlcg71-door-lock.json": ("reed_ohms", "door_verified"),
}
