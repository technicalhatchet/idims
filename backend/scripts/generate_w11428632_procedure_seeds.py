#!/usr/bin/env python3
"""Generate W11428632 (Whirlpool WTW5057 PSC top-load washer) procedure seed JSON files."""
...
OUT = ROOT / "frontend" / "components" / "diagnostics" / "procedures" / "seed" / "whirlpool_tl_psc_washer"
BUNDLE_OUT = OUT / "bundles"
PLATFORM = "whirlpool_tl_psc_washer"

SOURCE = {
    "manualId": "W11428632",
    "manualTitle": "Whirlpool Multimedia Enhanced Top Load Washer (W11428632C)",
    "extractedTextFile": "backend/docs/manuals/technical-manual-w11428632-revC-extracted.txt",
...
PROCEDURES = [
    ...
    proc(
        ...
        [
            instr("valve_live_precheck", 2, "Automatic Test valve pre-check", "In Automatic Test Mode, run automatic water valve sequence. Note any valve that fails to energize.", "disconnect_j8"),
            ...
            instr("reconnect_j8_power", 5, "Reconnect J8 and restore power", "Reconnect J8. Reassemble panels. Restore power for Automatic Test valve sequence.", "live_test_valves"),
            visual(
                "live_test_valves",
                6,
                "Valves energize in Automatic Test Mode",
                "Does each valve in question turn on during Automatic Test water valve sequence?",
                [
    ...
    proc(
        "w11428632-test-03-drive-system",
        ...
        [
            ...
            outcome("drive_deferred", 7, "Run TEST #3a or #3b", "Proceed to w11428632-test-03a-shifter or w11428632-test-03b-motor per fault code."),
        ],
    ),
    proc(
        "w11428632-test-03a-shifter",
...
PROCEDURE_FILES = [
    "w11428632-test-01-acu-power.json",
    "w11428632-test-02-valves.json",
    "w11428632-test-03-drive-system.json",
    "w11428632-test-03a-shifter.json",
    "w11428632-test-03b-motor.json",
    "w11428632-test-04-hmi.json",
    "w11428632-test-05-water-level.json",
    "w11428632-test-06-drain-pump.json",
    "w11428632-test-07-lid-lock.json",
]


def service_diagnostic_entry_bundle() -> dict:
    return {
        "id": "w11428632-service-diagnostic-entry",
        "version": "1.0.0",
        "platformId": PLATFORM,
        "manualId": "W11428632",
        "title": "W11428632 — Service Diagnostic mode entry",
...
def automatic_test_mode_bundle() -> dict:
    return {
        "id": "w11428632-automatic-test-mode",
        "version": "1.0.0",
        "platformId": PLATFORM,
        "manualId": "W11428632",
        "title": "W11428632 — Automatic Test Mode",
        "modeKind": "load_test",
        "uiVariants": ["console"],
...
BUNDLE_FILES = [
    "w11428632-service-diagnostic-entry.json",
    "w11428632-automatic-test-mode.json",
]
...
def write_catalog() -> None:
    catalog = {
        ...
        "platformId": PLATFORM,
        "templateId": "washer",
        "label": "Whirlpool/Maytag Multimedia Enhanced PSC top-load washer (W11428632)",
...
def write_readme() -> None:
    readme = """# whirlpool_tl_psc_washer — W11428632 procedure seeds
