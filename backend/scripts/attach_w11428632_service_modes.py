#!/usr/bin/env python3
"""Attach W11428632 service-mode bundles to procedure seeds."""
...
SPLIT_SERVICE_TEST_PROCEDURES: dict[str, tuple[str, str]] = {
    "w11428632-test-02-valves.json": ("valve_live_precheck", "live_test_valves"),
    "w11428632-test-06-drain-pump.json": ("reconnect_pump_power", "live_test_drain_pump"),
}

SINGLE_ENTRY_PROCEDURES: dict[str, tuple[str, str]] = {
    "w11428632-test-03-drive-system.json": ("safety_power_off", "enter_service_diag"),
    "w11428632-test-03a-shifter.json": ("safety_power_off", "shifter_service_test"),
    "w11428632-test-03b-motor.json": ("safety_power_off", "motor_wash_test"),
    "w11428632-test-04-hmi.json": ("safety_power_off", "hmi_service_test"),
    "w11428632-test-05-water-level.json": ("safety_power_off", "pressure_sensor_feedback"),
    "w11428632-test-07-lid-lock.json": ("safety_power_off", "lid_lock_service_test"),
}
...
def split_service_modes(attach_after: str, continue_to: str) -> list[dict[str, str]]:
    return [
        {
            "bundleId": "w11428632-service-diagnostic-entry",
            "modeKind": "service_diagnostic_entry",
            "attachAfterStepId": attach_after,
            "continueToStepId": "service_mode_before_test",
        },
        {
            "bundleId": "w11428632-automatic-test-mode",
            "modeKind": "load_test",
