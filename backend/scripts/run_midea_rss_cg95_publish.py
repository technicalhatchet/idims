#!/usr/bin/env python3
"""CG-9.5 WP4 — Publish Midea RSS SxS manufacturer overlay."""
...
def main() -> int:
    print("==> CG-9.5 Midea RSS SxS WP4 publish")
    ...
    promotion_id = f"promo-MIDEA-RSS-FRIDGE-CG95-{datetime.now(timezone.utc).strftime('%Y%m%d%H%M%S')}"
    ...
    pub_path = CALIBRATION_DIR / "publication_MIDEA_RSS_SXS_CG95.json"
    ...
    print("\n=== CG-9.5 Midea RSS SxS published ===")
