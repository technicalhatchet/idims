#!/usr/bin/env python3
"""Apply SAMSUNG-FL-BB8700-DRYER human gate from overlay mapping table v1."""
...
TABLE_PATH = (
    ...
    / "normalization"
    / "calibration"
    / "SAMSUNG_FL_BB8700_DRYER_overlay_mapping_table_v1.json"
)
MANUAL_ID = "SAMSUNG-FL-BB8700-DRYER"
REVIEWER = "human_gate"
...
def main() -> int:
    ...
    for cid, resolved in sorted(approve_map.items()):
        update_candidate_status(
            ...
            "approved",
            reviewer=REVIEWER,
            reason="SAMSUNG-FL-BB8700-DRYER overlay mapping table v1",
            manual_id=MANUAL_ID,
