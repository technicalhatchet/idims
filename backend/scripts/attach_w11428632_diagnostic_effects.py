#!/usr/bin/env python3
"""Attach diagnosticEffects to W11428632 procedure branches that lack them."""
...
PROCEDURE_COMPONENT: dict[str, str] = {
    "w11428632-test-01-acu-power": "supply",
    "w11428632-test-02-valves": "inlet_valve",
    "w11428632-test-03-drive-system": "drive_motor",
    "w11428632-test-03a-shifter": "drive_motor",
    "w11428632-test-03b-motor": "drive_motor",
    "w11428632-test-04-hmi": "hmi_control",
    "w11428632-test-05-water-level": "water_level_sensor",
    "w11428632-test-06-drain-pump": "drain_pump",
    "w11428632-test-07-lid-lock": "door_lock",
}
...
def main() -> None:
    total = 0
    for path in sorted(SEED_DIR.glob("w11428632-test-*.json")):
