#!/usr/bin/env python3
"""Attach diagnosticEffects to W11174426 freestanding range procedure branches."""
...
PROCEDURE_COMPONENT: dict[str, str] = {
    "w11174426-acu-power": "supply",
    "w11174426-hmi": "supply",
    "w11174426-oven-sensor": "temp_sensor",
    "w11174426-door-latch": "temp_sensor",
    "w11174426-bake-element": "bake_element",
    "w11174426-broil-element": "broil_element",
    "w11174426-infinite-switch": "bake_element",
    "w11174426-dsi-board": "gas_valve",
    "w11174426-surface-spark": "surface_ignition",
}
...
KNOWLEDGE_EVIDENCE: dict[str, tuple[str, str, str]] = {
    ...
    "bakeElementOhms": COMPONENT_DEFAULT_EVIDENCE["bake_element"],
