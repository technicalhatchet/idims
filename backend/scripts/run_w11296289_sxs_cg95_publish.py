#!/usr/bin/env python3
"""CG-9.5 WP2 — Publish Whirlpool W11296289 SxS manufacturer overlay."""
...
def main() -> int:
    print("==> CG-9.5 Whirlpool W11296289 SxS WP2 publish")
    ...
    promotion_id = f"promo-W11296289-SXS-CG95-{datetime.now(timezone.utc).strftime('%Y%m%d%H%M%S')}"
    ...
    pub_path = CALIBRATION_DIR / "publication_W11296289_SXS_CG95.json"
    ...
    print("\n=== CG-9.5 Whirlpool W11296289 SxS published ===")
