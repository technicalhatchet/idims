#!/usr/bin/env python3
"""Attach W11455152 diagram references to WTW6157 washer procedure measurement steps."""
...
ASSET_BASE = "/images/procedures/whirlpool_tl_dd_6157"
...
DIAGRAMS: dict[str, dict[str, str]] = {
    "w11455152-acu-pinout": {
        ...
        "assetPath": f"{ASSET_BASE}/w11455152-acu-pinout.png",
    },
}

PINOUT = "w11455152-acu-pinout"
...
def main() -> None:
    total = 0
    for path in sorted(SEED_DIR.glob("w11455152-*.json")):
