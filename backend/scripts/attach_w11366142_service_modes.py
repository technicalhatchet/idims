#!/usr/bin/env python3
"""Attach W11480208 Service Diagnostics entry bundle to W11366142 live-test procedures."""
...
BRIDGE_STEP = {
    ...
    "body": (
        ...
        "Continue with live checks below."
    ),
    "sourceExcerpt": "Refer to strip circuit; use Service Diagnostics Cycle for live load verification.",
    "requiresInput": False,
}

LIVE_TEST_PROCEDURES: dict[str, str] = {
    "w11366142-drain-motor.json": "live_drain",
    "w11366142-vent-wax-motor.json": "live_vent_wax",
    "w11366142-tub-light.json": "live_tub_light",
}
