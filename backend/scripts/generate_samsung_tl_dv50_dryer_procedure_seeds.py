#!/usr/bin/env python3
"""Generate Samsung TL DV50 dryer (DVE50R / DVG50R) procedure seed JSON files."""
...
OUT = ROOT / "frontend" / "components" / "diagnostics" / "procedures" / "seed" / "samsung_tl_dryer_dv50"
BUNDLE_OUT = OUT / "bundles"

SOURCE = {
    "manualId": "SAMSUNG-TL-DV50-DRYER",
    "manualTitle": "Samsung Top-Load / Vented Dryer DV50R Family (DVE50R, DVG50R)",
    "extractedTextFile": "backend/docs/manuals/samsung tl dryer dv50r5200-extracted.txt",
...
PROCEDURES = [
    ...
    proc(
        "samsungtldv50-gas-flame-sensor",
...
def smart_install_bundle() -> dict:
    return {
        "id": "samsungtldv50-smart-install-entry",
        "version": "1.0.0",
        "platformId": "samsung_tl_dryer_dv50",
        "manualId": SOURCE["manualId"],
        "title": "Samsung TL DV50 — Smart Install entry",
