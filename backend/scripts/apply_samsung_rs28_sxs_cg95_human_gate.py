#!/usr/bin/env python3
"""CG-9.5 WP1 — Apply human gate approval for Samsung RS28 SxS compounding."""
...
TABLE_PATH = CALIBRATION / "SAMSUNG_RS28_SXS_overlay_mapping_table_v1.json"
LEDGER_PATH = CALIBRATION / "SAMSUNG_RS28_SXS_gate_decision_ledger_v1.json"
OBSERVATION_PATH = CALIBRATION / "SAMSUNG_RS28_SXS_cg95_compounding_observation_v1.json"
REVIEWER = "human_gate_cg95_wp1"
...
def main() -> int:
    ...
    observation = {
        ...
        "verdictNote": (
            "First SxS production compounding against frozen refrigerator contract. "
            "Inverter PBA, IO expander, multi-NTC scopes, and C-fan ambiguity absorbed "
            "by conditional/platform layers. door_switch and condenser_fan withheld. "
            "RF23BB french-door overlay not imported. CG-9 boundary evidence informative only."
        ),
        "gateArtifact": TABLE_PATH.name,
    ...
    print("==> CG-9.5 WP1 Samsung RS28 SxS human gate applied")
