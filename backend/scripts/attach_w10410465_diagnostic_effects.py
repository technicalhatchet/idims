#!/usr/bin/env python3
"""Attach diagnosticEffects to W10680150 CCU dryer procedure branches."""
...
PROCEDURE_COMPONENT: dict[str, str] = {
    "w10410465-ccu-power": "ccu",
    "w10410465-supply-connections": "supply",
    "w10410465-motor-circuit": "motor",
    "w10410465-heater-electric": "heating_element",
    "w10410465-heater-gas": "gas_valve",
    "w10410465-thermistors": "exhaust_thermistor",
    "w10410465-thermal-fuse": "thermal_fuse",
    "w10410465-thermal-cutoff": "thermal_cutoff",
    "w10410465-gas-valve": "gas_valve",
    "w10410465-moisture-sensor": "moisture_sensor",
    "w10410465-dryness-adjust": "moisture_sensor",
    "w10410465-button-indicator": "user_interface",
    "w10410465-door-switch": "door_switch",
    "w10410465-drum-light": "drum_light",
    "w10410465-myst-valve": "steam_valve",
}

COMPONENT_DEFAULT_EVIDENCE: dict[str, tuple[str, str, str]] = {
    "ccu": ("ccu", "ed_kw_f1e1_ccu", "eliminate_heater_ol_heating_element_ok"),
