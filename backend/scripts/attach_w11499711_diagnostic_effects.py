#!/usr/bin/env python3
"""Attach diagnosticEffects to W11499711 WDT750 procedure branches."""
...
PROCEDURE_COMPONENT: dict[str, str] = {
    "w11499711-wash-motor-ssm": "circulation_pump",
}
...
def main() -> None:
    total = 0
    for path in sorted(SEED_DIR.glob("w11499711-*.json")):
