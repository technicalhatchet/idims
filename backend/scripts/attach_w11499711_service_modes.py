#!/usr/bin/env python3
"""Attach W11480208 Service Diagnostics entry bundle to W11499711 live-test procedures."""
...
# W11499711 reuses w11480208 service entry; only the new SSM wash procedure needs the bridge.
LIVE_TEST_PROCEDURES: dict[str, str] = {
    "w11499711-wash-motor-ssm.json": "live_wash_motor",
}
