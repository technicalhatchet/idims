#!/usr/bin/env python3
"""Attach diagnosticEffects to W10864849 procedure branches that lack them."""
...
PROCEDURE_COMPONENT: dict[str, str] = {
    "w10864849-test-01-acu-power": "supply",
    "w10864849-test-02-valves": "inlet_valve",
    "w10864849-test-03-drive-system": "drive_motor",
    "w10864849-test-03a-shifter": "drive_motor",
    "w10864849-test-03b-motor": "drive_motor",
    "w10864849-test-04-keys-encoders": "hmi_control",
    "w10864849-test-05-temp-thermistor": "wash_ntc",
    "w10864849-test-06-water-level": "water_level_sensor",
    "w10864849-test-07-drain-recirc-pump": "drain_pump",
    "w10864849-test-08-lid-lock": "door_lock",
    "w10864849-test-09-heater": "wash_heater",
    "w10864849-test-10-service-leds": "hmi_control",
    "w10864849-test-11-basket-light": "supply",
    "w10864849-test-12-bulk-dispense": "bulk_level_switch",
}
