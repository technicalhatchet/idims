#!/usr/bin/env python3
"""Attach diagnosticEffects to W11416805 ACU top-load dryer procedure branches."""
...
PROCEDURE_COMPONENT: dict[str, str] = {
    "w11416805-acu-power": "acu",
    "w11416805-supply-connections": "supply",
    "w11416805-motor-circuit": "motor",
    "w11416805-heater-electric": "heating_element",
    "w11416805-heater-gas": "gas_valve",
    "w11416805-thermistors": "exhaust_thermistor",
    "w11416805-thermal-fuse": "thermal_fuse",
    "w11416805-thermal-cutoff": "thermal_cutoff",
    "w11416805-gas-valve": "gas_valve",
    "w11416805-moisture-sensor": "moisture_sensor",
    "w11416805-hmi": "user_interface",
    "w11416805-door-switch": "door_switch",
    "w11416805-drum-light": "drum_light",
    "w11416805-water-valve": "steam_valve",
}
