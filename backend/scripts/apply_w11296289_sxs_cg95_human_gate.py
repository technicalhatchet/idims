#!/usr/bin/env python3
"""CG-9.5 WP2 — Apply human gate approval for Whirlpool W11296289 SxS compounding."""
...
TABLE_PATH = CALIBRATION / "W11296289_SXS_overlay_mapping_table_v1.json"
LEDGER_PATH = CALIBRATION / "W11296289_SXS_gate_decision_ledger_v1.json"
OBSERVATION_PATH = CALIBRATION / "W11296289_SXS_cg95_compounding_observation_v1.json"
REVIEWER = "human_gate_cg95_wp2"
...
def main() -> int:
    ...
    observation = {
        ...
        "verdictNote": (
            "Second SxS production compounding — full KEEP inheritance including dedicated "
            "door_switch procedures and explicit condenser_fan conditional on step 7. "
            "Relay-drive EM3Y60 compressor, stepper damper, THESEUS/ATHENA variants as platform. "
            "Jazz french-door and Samsung SxS overlays not imported. Five refrigerator overlays "
            "now on frozen contract."
        ),
        "gateArtifact": TABLE_PATH.name,
    ...
    print("==> CG-9.5 WP2 Whirlpool W11296289 SxS human gate applied")
