#!/usr/bin/env python3
"""Attach diagnosticEffects to W11480208 filtration dishwasher procedure branches."""
...
PROCEDURE_COMPONENT: dict[str, str] = {
    "w11480208-door-switch": "door_gasket",
    "w11480208-heater": "heater",
    "w11480208-overfill-switch": "inlet_valve",
    "w11480208-diverter-motor": "circulation_pump",
    "w11480208-wash-motor-vsm": "circulation_pump",
    "w11480208-drain-motor-vsm": "drain_pump",
    "w11480208-dc-fan": "heater",
    "w11480208-interior-led": "heater",
}
...
def main() -> None:
    total = 0
    for path in sorted(SEED_DIR.glob("w11480208-*.json")):
