#!/usr/bin/env python3
"""CG-9.5 WP3 — Publish LG LSC27926 SxS manufacturer overlay."""
...
def main() -> int:
    print("==> CG-9.5 LG LSC27926 SxS WP3 publish")
    ...
    promotion_id = f"promo-LG-LSC27926-SXS-CG95-{datetime.now(timezone.utc).strftime('%Y%m%d%H%M%S')}"
    ...
    pub_path = CALIBRATION_DIR / "publication_LG_LSC27926_SXS_CG95.json"
    ...
    print("\n=== CG-9.5 LG LSC27926 SxS published ===")
