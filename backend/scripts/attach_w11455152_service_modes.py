#!/usr/bin/env python3
"""Attach W11455152 service-mode bundles to procedure seeds."""
...
BRIDGE_STEP = {
    ...
    "body": "You should now be in Service Diagnostic mode. Press Key 2 then START to enter Automatic Test Mode for load/function commands.",
...
SPLIT_SERVICE_TEST_PROCEDURES: dict[str, tuple[str, str]] = {
    "w11455152-test-02-valves.json": ("valve_live_precheck", "live_test_valves"),
    "w11455152-test-06-drain-pump.json": ("reconnect_pump_power", "live_test_drain_pump"),
}

SINGLE_ENTRY_PROCEDURES: dict[str, tuple[str, str]] = {
    "w11455152-test-03-drive-system.json": ("safety_power_off", "enter_service_diag"),
    "w11455152-test-03a-shifter.json": ("safety_power_off", "shifter_service_test"),
    "w11455152-test-03b-motor.json": ("safety_power_off", "motor_wash_test"),
    "w11455152-test-04-hmi.json": ("safety_power_off", "hmi_service_test"),
    "w11455152-test-05-water-level.json": ("safety_power_off", "pressure_sensor_feedback"),
    "w11455152-test-07-lid-lock.json": ("safety_power_off", "lid_lock_service_test"),
}
...
def split_service_modes(attach_after: str, continue_to: str) -> list[dict[str, str]]:
    return [
        {
            "bundleId": "w11455152-service-diagnostic-entry",
            "modeKind": "service_diagnostic_entry",
            "attachAfterStepId": attach_after,
            "continueToStepId": "service_mode_before_test",
        },
        {
            "bundleId": "w11455152-automatic-test-mode",
            "modeKind": "load_test",
